...
public class EditProfileActivity extends AppCompatActivity {
    ...
    EditText fullname, username, bio, age, gender, location;
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        auth.sendPasswordResetEmail(mail).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(EditProfileActivity.this,"Reset Link Sent To You Email.", Toast.LENGTH_SHORT).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(EditProfileActivity.this,"Error! Reset Link Is Not Sent" + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
    ...
    private void updateProfile(String fullname, String username, String bio,String age,String gender,String location){
